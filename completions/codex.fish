...
function __fish_codex_global_optspecs
	string join \n c/config= enable= disable= remote= remote-auth-token-env= strict-config i/image= m/model= oss local-provider= p/profile= s/sandbox= dangerously-bypass-hook-trust C/cd= worktree add-dir= dangerously-bypass-approvals-and-sandbox approve-for-me a/ask-for-approval= search no-alt-screen h/help V/version
end
...
complete -c codex -n "__fish_codex_needs_command" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand exec; and not __fish_seen_subcommand_from resume fork review help" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand exec; and __fish_seen_subcommand_from resume" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand exec; and __fish_seen_subcommand_from fork" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand exec; and __fish_seen_subcommand_from review" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand e; and not __fish_seen_subcommand_from resume fork review help" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand e; and __fish_seen_subcommand_from resume" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand e; and __fish_seen_subcommand_from fork" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand e; and __fish_seen_subcommand_from review" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from daemon proxy generate-ts generate-json-schema generate-internal-json-schema help" -l managed-daemon -d 'Save loaded threads during managed daemon shutdown'
...
complete -c codex -n "__fish_codex_using_subcommand app-server; and __fish_seen_subcommand_from daemon" -f -a "update" -d 'Update the standalone installation and restart the managed daemon (may interrupt work)'
...
complete -c codex -n "__fish_codex_using_subcommand resume" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand queue" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand archive" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand delete" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand unarchive" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand fork" -l worktree -d 'Run the session in a new managed Git worktree'
...
complete -c codex -n "__fish_codex_using_subcommand exec-server; and not __fish_seen_subcommand_from forward help" -l aws-profile -d 'AWS profile used for SigV4 authentication' -r
complete -c codex -n "__fish_codex_using_subcommand exec-server; and not __fish_seen_subcommand_from forward help" -l aws-region -d 'AWS signing region. Uses the SDK region chain when omitted' -r
complete -c codex -n "__fish_codex_using_subcommand exec-server; and not __fish_seen_subcommand_from forward help" -l aws-service -d 'AWS signing service' -r
...
complete -c codex -n "__fish_codex_using_subcommand exec-server; and not __fish_seen_subcommand_from forward help" -l aws-sigv4 -d 'Sign Direct registration and WebSocket handshake requests with AWS SigV4'
...
complete -c codex -n "__fish_codex_using_subcommand exec-server; and __fish_seen_subcommand_from forward" -l aws-profile -d 'AWS profile used for SigV4 authentication' -r
complete -c codex -n "__fish_codex_using_subcommand exec-server; and __fish_seen_subcommand_from forward" -l aws-region -d 'AWS signing region. Uses the SDK region chain when omitted' -r
complete -c codex -n "__fish_codex_using_subcommand exec-server; and __fish_seen_subcommand_from forward" -l aws-service -d 'AWS signing service' -r
...
complete -c codex -n "__fish_codex_using_subcommand exec-server; and __fish_seen_subcommand_from forward" -l aws-sigv4 -d 'Sign Direct registration and WebSocket handshake requests with AWS SigV4'
