...
function __fish_codex_global_optspecs
	string join \n c/config= enable= disable= remote= remote-auth-token-env= i/image= m/model= oss local-provider= p/profile= s/sandbox= C/cd= add-dir= dangerously-bypass-approvals-and-sandbox a/ask-for-approval= search no-alt-screen h/help V/version
end
...
complete -c codex -n "__fish_codex_using_subcommand login; and not __fish_seen_subcommand_from status help" -l with-agent-identity -d 'Read the experimental Agent Identity token from stdin (e.g. `printenv CODEX_AGENT_IDENTITY | codex login --with-agent-identity`)'
...
complete -c codex -n "__fish_codex_using_subcommand plugin; and not __fish_seen_subcommand_from marketplace help" -s c -l config -d 'Override a configuration value that would otherwise be loaded from `~/.codex/config.toml`. Use a dotted path (`foo.bar.baz`) to override nested values. The `value` portion is parsed as TOML. If it fails to parse as TOML, the raw string is used as a literal' -r
complete -c codex -n "__fish_codex_using_subcommand plugin; and not __fish_seen_subcommand_from marketplace help" -l enable -d 'Enable a feature (repeatable). Equivalent to `-c features.<name>=true`' -r
complete -c codex -n "__fish_codex_using_subcommand plugin; and not __fish_seen_subcommand_from marketplace help" -l disable -d 'Disable a feature (repeatable). Equivalent to `-c features.<name>=false`' -r
complete -c codex -n "__fish_codex_using_subcommand plugin; and not __fish_seen_subcommand_from marketplace help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c codex -n "__fish_codex_using_subcommand plugin; and not __fish_seen_subcommand_from marketplace help" -f -a "marketplace" -d 'Manage plugin marketplaces for Codex'
complete -c codex -n "__fish_codex_using_subcommand plugin; and not __fish_seen_subcommand_from marketplace help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c codex -n "__fish_codex_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -f -a "add"
complete -c codex -n "__fish_codex_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -f -a "upgrade"
complete -c codex -n "__fish_codex_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -f -a "remove"
...
complete -c codex -n "__fish_codex_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "marketplace" -d 'Manage plugin marketplaces for Codex'
...
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l listen -d 'Transport endpoint URL. Supported values: `stdio://` (default), `unix://`, `unix://PATH`, `ws://IP:PORT`, `off`' -r
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l ws-auth -d 'Websocket auth mode for non-loopback listeners' -r -f -a "capability-token\t''
signed-bearer-token\t''"
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l ws-token-file -d 'Absolute path to the capability-token file' -r -F
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l ws-token-sha256 -d 'Hex-encoded SHA-256 digest of the capability token' -r
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l ws-shared-secret-file -d 'Absolute path to the shared secret file for signed JWT bearer tokens' -r -F
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l ws-issuer -d 'Expected issuer for signed JWT bearer tokens' -r
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l ws-audience -d 'Expected audience for signed JWT bearer tokens' -r
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l ws-max-clock-skew-seconds -d 'Maximum clock skew when validating signed JWT bearer tokens' -r
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -s c -l config -d 'Override a configuration value that would otherwise be loaded from `~/.codex/config.toml`. Use a dotted path (`foo.bar.baz`) to override nested values. The `value` portion is parsed as TOML. If it fails to parse as TOML, the raw string is used as a literal' -r
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l enable -d 'Enable a feature (repeatable). Equivalent to `-c features.<name>=true`' -r
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l disable -d 'Disable a feature (repeatable). Equivalent to `-c features.<name>=false`' -r
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -l analytics-default-enabled -d 'Controls whether analytics are enabled by default'
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -f -a "proxy" -d 'Proxy stdio bytes to the running app-server control socket'
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -f -a "generate-ts" -d '[experimental] Generate TypeScript bindings for the app server protocol'
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -f -a "generate-json-schema" -d '[experimental] Generate JSON Schema for the app server protocol'
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -f -a "generate-internal-json-schema" -d '[internal] Generate internal JSON Schema artifacts for Codex tooling'
complete -c codex -n "__fish_codex_using_subcommand app-server; and not __fish_seen_subcommand_from proxy generate-ts generate-json-schema generate-internal-json-schema help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c codex -n "__fish_codex_using_subcommand exec-server" -l listen -d 'Transport endpoint URL. Supported values: `ws://IP:PORT` (default)' -r
...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "exec" -d 'Run Codex non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "review" -d 'Run a code review non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "login" -d 'Manage login'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "logout" -d 'Remove stored authentication credentials'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "mcp" -d 'Manage external MCP servers for Codex'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "plugin" -d 'Manage Codex plugins'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "mcp-server" -d 'Start Codex as an MCP server (stdio)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "app-server" -d '[experimental] Run the app server or related tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "update" -d 'Update Codex to the latest version'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "sandbox" -d 'Run commands within a Codex-provided sandbox'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "debug" -d 'Debugging tools'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "execpolicy" -d 'Execpolicy tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "apply" -d 'Apply the latest diff produced by Codex agent as a `git apply` to your local working tree'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "resume" -d 'Resume a previous interactive session (picker by default; use --last to continue the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "fork" -d 'Fork a previous interactive session (picker by default; use --last to fork the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "cloud" -d '[EXPERIMENTAL] Browse tasks from Codex Cloud and apply changes locally'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "responses-api-proxy" -d 'Internal: run the responses API proxy'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "stdio-to-uds" -d 'Internal: relay stdio to a Unix domain socket'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "exec-server" -d '[EXPERIMENTAL] Run the standalone exec-server service'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "features" -d 'Inspect feature flags'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion update sandbox debug execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c codex -n "__fish_codex_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "marketplace" -d 'Manage plugin marketplaces for Codex'
