...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "exec" -d 'Run Codex non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "review" -d 'Run a code review non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "login" -d 'Manage login'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "logout" -d 'Remove stored authentication credentials'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "mcp" -d 'Manage external MCP servers for Codex'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "plugin" -d 'Manage Codex plugins'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "mcp-server" -d 'Start Codex as an MCP server (stdio)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "app-server" -d '[experimental] Run the app server or related tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "remote-control" -d '[experimental] Manage the app-server daemon with remote control enabled'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "update" -d 'Update Codex to the latest version'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "doctor" -d 'Diagnose local Codex installation, config, auth, and runtime health'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "sandbox" -d 'Run commands within a Codex-provided sandbox'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "debug" -d 'Debugging tools'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "execpolicy" -d 'Execpolicy tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "apply" -d 'Apply the latest diff produced by Codex agent as a `git apply` to your local working tree'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "resume" -d 'Resume a previous interactive session (picker by default; use --last to continue the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "archive" -d 'Archive a saved session by id or session name'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "delete" -d 'Permanently delete a saved session by id or session name'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "migrate-rollouts" -d 'Inspect or migrate legacy local sessions to paginated thread history'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "unarchive" -d 'Unarchive a saved session by id or session name'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "fork" -d 'Fork a previous interactive session (picker by default; use --last to fork the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "cloud" -d '[EXPERIMENTAL] Browse tasks from Codex Cloud and apply changes locally'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "responses-api-proxy" -d 'Internal: run the responses API proxy'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "stdio-to-uds" -d 'Internal: relay stdio to a Unix domain socket'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "exec-server" -d '[EXPERIMENTAL] Run the standalone exec-server service'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "features" -d 'Inspect feature flags'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server remote-control completion update doctor sandbox debug execpolicy apply resume archive delete migrate-rollouts unarchive fork cloud responses-api-proxy stdio-to-uds exec-server features help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
