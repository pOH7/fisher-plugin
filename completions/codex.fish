...
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -s c -l config -d 'Override a configuration value that would otherwise be loaded from `~/.codex/config.toml`. Use a dotted path (`foo.bar.baz`) to override nested values. The `value` portion is parsed as TOML. If it fails to parse as TOML, the raw string is used as a literal' -r
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -l enable -d 'Enable a feature (repeatable). Equivalent to `-c features.<name>=true`' -r
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -l disable -d 'Disable a feature (repeatable). Equivalent to `-c features.<name>=false`' -r
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -f -a "models" -d 'Render the raw model catalog as JSON'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -f -a "app-server" -d 'Tooling: helps debug the app server'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -f -a "prompt-input" -d 'Render the model-visible prompt input list as JSON'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -f -a "clear-memories" -d 'Internal: reset local memory state for a fresh start'
complete -c codex -n "__fish_codex_using_subcommand debug; and not __fish_seen_subcommand_from models app-server prompt-input clear-memories help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "exec" -d 'Run Codex non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "review" -d 'Run a code review non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "login" -d 'Manage login'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "logout" -d 'Remove stored authentication credentials'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "mcp" -d 'Manage external MCP servers for Codex'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "plugin" -d 'Manage Codex plugins'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "mcp-server" -d 'Start Codex as an MCP server (stdio)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "app-server" -d '[experimental] Run the app server or related tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "sandbox" -d 'Run commands within a Codex-provided sandbox'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "debug" -d 'Debugging tools'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "execpolicy" -d 'Execpolicy tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "apply" -d 'Apply the latest diff produced by Codex agent as a `git apply` to your local working tree'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "resume" -d 'Resume a previous interactive session (picker by default; use --last to continue the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "fork" -d 'Fork a previous interactive session (picker by default; use --last to fork the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "cloud" -d '[EXPERIMENTAL] Browse tasks from Codex Cloud and apply changes locally'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "responses-api-proxy" -d 'Internal: run the responses API proxy'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "responses" -d 'Internal: send one raw Responses API payload through Codex auth'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "stdio-to-uds" -d 'Internal: relay stdio to a Unix domain socket'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "exec-server" -d '[EXPERIMENTAL] Run the standalone exec-server service'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "features" -d 'Inspect feature flags'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp plugin mcp-server app-server completion sandbox debug execpolicy apply resume fork cloud responses-api-proxy responses stdio-to-uds exec-server features help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
